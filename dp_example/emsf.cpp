...
namespace emsf {
  ...
  stoch_mat generate_stochastic_matrix(const Natural nrows, const Natural ncols, const bool constant, const bool one)
  {
    stoch_mat M;
    if (one) {
  ...
  v_stoch_mat generate_stochastic_matrices(const Natural nrows,const Natural ncols, const Natural na, const bool constant, const bool one)
  {
    v_stoch_mat M;
    M.resize(na);
  ...
  Real em_sf_sk(model &md, v_data &dt, const Natural n, const Natural m, const Natural na, const Natural num_episodes, v_stoch_mat D, v_stoch_mat K, const Real eps = 1e-20, const Natural max_it = 10)
  {
    v_stoch_mat P = md.P;
    vec mu = md.mu;
    stoch_mat pi = md.pi;
